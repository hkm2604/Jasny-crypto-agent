import { getTicker, getOHLCV, calculateIndicators, getOrderBook } from "./build/tools.js";

async function testAll() {
  console.log("🚀 Memulakan ujian untuk COMPILED Crypto Agent Tools...");
  ...
  try {
    ...
    // 3. Test calculateIndicators (RSI, SMA)
    console.log(`\n3. Testing calculateIndicators for ${symbol}...`);
